...
namespace Middleware.VolleyballService {
    ...
    public interface IVolleyballService {
        ...
        System.Collections.Generic.List<System.Collections.Generic.Dictionary<string, string>> FindSerchResults(string serchableName, Middleware.VolleyballService.TablesNames tableName, Middleware.VolleyballService.Gender gender);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IVolleyballService/FindSerchResults", ReplyAction="http://tempuri.org/IVolleyballService/FindSerchResultsResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<System.Collections.Generic.Dictionary<string, string>>> FindSerchResultsAsync(string serchableName, Middleware.VolleyballService.TablesNames tableName, Middleware.VolleyballService.Gender gender);
    ...
    public partial class VolleyballServiceClient : System.ServiceModel.ClientBase<Middleware.VolleyballService.IVolleyballService>, Middleware.VolleyballService.IVolleyballService {
        ...
        public System.Collections.Generic.List<System.Collections.Generic.Dictionary<string, string>> FindSerchResults(string serchableName, Middleware.VolleyballService.TablesNames tableName, Middleware.VolleyballService.Gender gender) {
            return base.Channel.FindSerchResults(serchableName, tableName, gender);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<System.Collections.Generic.Dictionary<string, string>>> FindSerchResultsAsync(string serchableName, Middleware.VolleyballService.TablesNames tableName, Middleware.VolleyballService.Gender gender) {
            return base.Channel.FindSerchResultsAsync(serchableName, tableName, gender);
        }
