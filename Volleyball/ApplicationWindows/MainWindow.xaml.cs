...
namespace Volleyball
{
    public partial class MainWindow : Window
    {
        ...
        private void LoginButton_Click( object sender , RoutedEventArgs e )
        {
            ...
            client.Insert( t1.ConvertInstanceToDictionary() , Middleware.VolleyballService.TablesNames.Teams );
            client.Insert( t2.ConvertInstanceToDictionary() , Middleware.VolleyballService.TablesNames.Teams );
            client.Insert( t3.ConvertInstanceToDictionary() , Middleware.VolleyballService.TablesNames.Teams );
            client.Insert( t4.ConvertInstanceToDictionary() , Middleware.VolleyballService.TablesNames.Teams );
